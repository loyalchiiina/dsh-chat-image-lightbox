...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    function ensureLightbox() {
      ...
      lightboxImg.addEventListener("click", function (e) { e.stopPropagation(); lightboxImg.classList.toggle("dsh-ig-zoomed"); });
    ...
    function close() {
      ...
      if (lightboxImg) lightboxImg.classList.remove("dsh-ig-zoomed");
